...
{
    if(Height > pindexBest->nHeight) { return "0x8b6d9062479865e08c9d1218a3b9dfbd2ecf42e9b5d710e909b6ecb7e3ac1175"; }
    if(Height < 0) { return "0x8b6d9062479865e08c9d1218a3b9dfbd2ecf42e9b5d710e909b6ecb7e3ac1175"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " JPC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " JPC");
    }
}
